            ...
            IConventionContext<IConventionAnnotation> context)
        {
                ...
                || name == SqlServerAnnotationNames.TemporalPeriodEndPropertyName)
            {
                if (oldAnnotation?.Value is string oldPeriodPropertyName)
                {
                    ...
                    {
                        if (oldPeriodProperty.GetValueGeneratedConfigurationSource() == ConfigurationSource.Convention
                            && oldPeriodProperty.ValueGenerated == ValueGenerated.OnAddOrUpdate)
                        {
                            oldPeriodProperty.SetValueGenerated(ValueGenerated.Never);
                        }
